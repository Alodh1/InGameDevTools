...
public sealed class FirstPersonAnimationsBehavior : EntityBehavior, IDisposable
{
    ...
    {
        _player = entity as EntityPlayer ?? throw new ArgumentException("Only player entities can preview Overhaul animations.");
    ...
    public override string PropertyName() => "OverhaulDevTools:FirstPersonAnimations";
...
public sealed class ThirdPersonAnimationsBehavior : EntityBehavior, IDisposable
{
    ...
    public override string PropertyName() => "OverhaulDevTools:ThirdPersonAnimations";
